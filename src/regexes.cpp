...
std::regex reg_reg_dir("%(r[0-7]|pc)$");
std::regex reg_reg_ind("\\(%(r[0-7]||pc)\\)$");
std::regex reg_literal_reg_off("\b([\\d]+)\\(%(r[0-7]|pc)\\)$"); //mozda treba b 2 puta da se esc
std::regex reg_symbol_reg_off("\b([\\w][\\d\\w]+)\\(%(r[0-7]|pc)\\)$");
std::regex reg_pc_rel("\b([\\w][\\d\\w]+)\\(%(r7|pc)\\)$");
...
std::regex reg_jmp_reg_dir("\\*%(r[0-7]|pc)$");
std::regex reg_jmp_reg_ind("\\*\\(%(r[0-7]||pc)\\)$");
std::regex reg_jmp_literal_reg_off("\\*\b([\\d]+)\\(%(r[0-7]|pc)\\)$");
std::regex reg_jmp_symbol_reg_off("\\*\b([\\w][\\d\\w]+)\\(%(r[0-7]|pc)\\)$");
std::regex reg_jmp_pc_rel("\\*\b([\\w][\\d\\w]+)\\(%(r7|pc)\\)$");
